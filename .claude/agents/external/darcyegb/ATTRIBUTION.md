...
These agents are sourced from [darcyegb/ClaudeCodeAgents](https://github.com/darcyegb/ClaudeCodeAgents) repository.

## Original Author
- **Author**: darcyegb
- **Repository**: https://github.com/darcyegb/ClaudeCodeAgents
...
For the most up-to-date version of these agents, please visit the [original repository](https://github.com/darcyegb/ClaudeCodeAgents).
